package com.engeto.c_map.d_orders;
...
public class OrdersMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Počet objednávek s ID order123: " + orderCounts.get("order123")); // Výstup: Počet objednávek s ID order123: 2
        System.out.println("Počet objednávek s ID order124: " + orderCounts.get("order124")); // Výstup: Počet objednávek s ID order124: 2
