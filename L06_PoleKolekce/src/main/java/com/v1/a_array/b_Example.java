...
public class b_Example {
  ...
  public static void main(String[] args) {
    ...
    // Example 2 : jednoduchy priklad pro rozdeli stringu podle mezery
    String welcomString = "Welcome in Java Academy";
    String[] splitString = welcomString.split(" ");
    System.out.println(Arrays.toString(splitString));

    // Example 3 : funkce split se napriklad vyuziva pro dekodovani JW Tokenu
