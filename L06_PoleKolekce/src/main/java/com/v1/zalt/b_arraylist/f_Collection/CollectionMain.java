package com.v1.zalt.b_arraylist.f_Collection;
...
public class CollectionMain {
  ...
  public static void main(String[] args) {
    ...
    ArrayList<Double> dailyTemperatures = new ArrayList<>(
        List.of(16.5, 20.3, 18.2, 21.4, 19.6, 15.8));
    ...
    System.out.println(
        "Zaplněný seznam: " + slots); // Výstup: [Reserved, Reserved, Reserved, Reserved, Reserved]
