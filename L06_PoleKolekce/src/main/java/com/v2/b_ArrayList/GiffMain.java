...
public class GiffMain {
  ...
  public static void main(String[] args) {
    ...
    Giff giffForWife = new Giff("Kytka", Size.L, 100);
    Giff giffForMe = new Giff("Auto", Size.L, 200);
    ...
    listOfGift.add(new Giff("Letadlo", Size.L, 0));
    listOfGift.add(new Giff("Kniha", Size.L, 23));
